...
import { addData, getData, updateData, updateEmployerData,tokenConfig } from '../../../utils/database';
...
const Template1 = (props) => {
  ...
  console.log(token);
    ...
    //console.log(body);
    axios.post('/api/leads/', body, config)
        .then(
            ...
            <section className={classes.s2}>
                <div className={classes.maincontainer}>
                    ...
                    <form className={classes.contactForm}>
                        ...
                        <input className={classes.inputField} type="text" name="name" onChange={handleChange} />
                        <label style={{ color: 'var(--secondaryText)' }} className={classes.contactFormLabel}>Subject</label>
                        <input className={classes.inputField} type="text" name="subject" onChange={handleChange}/>
                        ...
                        <textarea className={classes.inputField} name="message" onChange={handleChange}></textarea>

                        <input className={classes.submitBtn} type="submit" value="Send" onClick={handleSubmit} />
                    </form>
                </div>
            </section>
        </ThemeChanger>
